//Jacky Li, Nathan Moreno ECE3301L.03
#include <p18f4620.h>
#include <stdio.h>
#include <math.h>
#include <usart.h>
...
#define EW_GREEN      PORTBbits.RB0

#define NSLT_RED      PORTEbits.RE1
#define NSLT_GREEN    PORTEbits.RE2

#define EWLT_RED      PORTBbits.RB1
#define EWLT_GREEN    PORTBbits.RB2
...
void Day_Mode()
{
                                                                     ...
                                                                     // Set NS light green and the rest to red
    ...
    {
        PED_Control(0,7);                                                           // If true, start pedestrian counter
        ...
        {
            PED_Control(1,6);                                                       // If true, start pedestrian counter
        }

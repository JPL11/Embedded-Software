...
#define DR3             0x01                        // Port E Start  
#define DG3             0x02                        
#define DB3             0x04   
#define DC3             0x06

#define DM3             0x05
#define DW3             0x07                        // PORT E End
...
char D3[21] =               // LED D3 color definitions
{
    DR3,DR3,DR3,
    DC3,DC3,DG3,
    DB3,DB3,DM3,
...
//                    }       
                ...
                if ( found == 3 )                                   // If EQ (the eight button on the IR remote) is pressed, Reset the time according to the time 
                {    

...
//    PORTE = 0xFF;                                               //
    ...
    char ON = D_POINT= 0; 
    char OFF = D_POINT = 1; 
//    float RREF = 10.0;                                             // Resistance used to measure unknown resistor in kOhms
//    float VREF = 4.096;
        ...
        while(1)
        {
            ...
            float RL = (10.0 * VOLT) / (4.096 - VOLT);           // Calculation of Resistance using Voltage Divider Rule
